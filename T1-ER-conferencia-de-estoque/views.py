...
def criar_produto():
    ...
    novo_produto = Estoque(
        setor=setor, nome=nome, marca_produto=marca_produto,
        validade=validade, fornecedor=fornecedor,
...
def modificar():
    id = request.form['id']
    produto_para_modificar = Estoque.query.filter_by(id=id).first()
    produto_para_modificar.setor = request.form['setor']
    produto_para_modificar.nome = request.form['nome']
    produto_para_modificar.marca_produto = request.form['marca_produto']
    produto_para_modificar.validade = request.form['validade']
    produto_para_modificar.fornecedor = request.form['fornecedor']
